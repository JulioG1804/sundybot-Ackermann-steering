...
def drawText(position, textString):
    font = pygame.font.SysFont("Courier", 18, False)
...
def drawText2(position, textString):
    font = pygame.font.SysFont("Courier", 15, False)
    textSurface = font.render(textString, True, (255, 255, 255, 255), (0, 0, 0, 255))
    textData = pygame.image.tostring(textSurface, "RGBA", True)
    glRasterPos3d(*position)
    glDrawPixels(textSurface.get_width(), textSurface.get_height(), GL_RGBA, GL_UNSIGNED_BYTE, textData)
...
def draw():
    ...
    drawText((-2, -2, 1), osd_line)
    drawText2((-2, -2, 2), "Press: 1 Offset | Press: 2 Reset | Press: z Yaw on/off")
